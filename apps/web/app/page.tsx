...
export default function Dashboard() {
  ...
  return (
    <main className="flex h-dvh flex-col gap-3 overflow-hidden p-3">
...
function Header({ onReset, refreshKey }: { onReset: () => void; refreshKey: number }) {
  ...
  return (
    <header className="flex shrink-0 flex-wrap items-center gap-x-4 gap-y-2 rounded-xl border border-ink-700 bg-ink-900/70 px-4 py-2.5 backdrop-blur">
      <div className="flex items-center gap-2.5">
        <div className="grid size-7 place-items-center rounded-lg bg-brand-500 text-[13px] font-bold text-ink-950">
          ₹
        </div>
        <div>
